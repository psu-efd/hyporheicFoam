...
::surfaceBottomFixedValueFvPatchScalarField
(
    const surfaceBottomFixedValueFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::surfaceBottomFixedValueFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
*/
    operator==
    (
       (DtFromSurfp/deltaCoeffFromSubp*(this->patchInternalField()) + DFromSubp/deltaCoeffFromSurfp*CFromSub_)
...
void Foam::surfaceBottomFixedValueFvPatchScalarField::write(Ostream& os) const
{
