...
::subsurfaceTopFixedValueFvPatchScalarField
(
    const subsurfaceTopFixedValueFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::subsurfaceTopFixedValueFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
*/
    ...
    operator==
    (
       theta*(DtFromSurfp/deltaCoeffFromSubp*CFromSurf_ + DFromSubp/deltaCoeffFromSurfp*(this->patchInternalField()))
...
void Foam::subsurfaceTopFixedValueFvPatchScalarField::write(Ostream& os) const
{
