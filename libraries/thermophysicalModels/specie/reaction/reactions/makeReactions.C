...
#include "MonodArrheniusReactionRate.H"
#include "MonodInhibitionArrheniusReactionRate.H"
...
#define makeReactions(Thermo, Reaction)                                        \
    ...
    makeIRNReactions(Thermo, MonodArrheniusReactionRate)                       \
    makeIRNReactions(Thermo, MonodInhibitionArrheniusReactionRate)                       \
                                                                               \
...
namespace Foam
{
    makeReactions(constGenericHThermoPhysics, constGenericHReaction)
    makeReactions(constGenericEThermoPhysics, constGenericEReaction)
}
