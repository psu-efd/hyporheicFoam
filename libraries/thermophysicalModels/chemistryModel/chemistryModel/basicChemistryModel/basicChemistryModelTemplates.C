...
//XL: fixed the thermoType
        thermoTypeName = "const<hConst<rhoConst<specie>>,sensibleEnthalpy>";
/*
...
*/
        ...
        // Construct the name of the chemistry type from the components
        {
            chemistryTypeName =
              ...
              + "chemistryModel<"
              //XL: limit "chemistryThermo" to "rho" only
              //+ word(chemistryTypeDict.lookup("chemistryThermo")) + ','
              + "rho" + ','
              + thermoTypeName + ">>";
        }

        //Info << "thermoTypeName = " << thermoTypeName << endl;
        ...
        if (cstrIter == ChemistryModel::fvMeshConstructorTablePtr_->end())
        {
            ...
            Info << "validChemistryTypeNames = " << validChemistryTypeNames << endl;
            ...
            //Info << "validChemistryTypeNameCmpts = " << validChemistryTypeNameCmpts << endl;
