...
{
    //check whether the dictionary "thermoDict" contains sub-dictionary "thermoType"
    ...
    {
        //XL: fix the thermoType
        //const word thermoTypeName(thermoDict.lookup("thermoType"));
        const word thermoTypeName("heRhoThermo<reactingMixture<const<hConst<rhoConst<specie>>,sensibleEnthalpy>>>");
